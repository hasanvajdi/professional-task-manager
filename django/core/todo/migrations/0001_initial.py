# Generated by Django 3.2.7 on 2022-05-02 07:27
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('group', models.ManyToManyField(to='todo.Group')),
            ],
        ),
        migrations.CreateModel(
            name='Profile',
            fields=[
                ...
                ('avatar', models.ImageField(blank=True, upload_to=todo.models.user_avatar)),
